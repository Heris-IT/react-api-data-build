...
var createBinding = function (endpointKey, bindingParams, dispatch, bindingsStore, instanceId, config) {
    ...
    return function (apiData, request) { return ({
        data: (0, getResultData_1.getResultData)(apiData, endpointKey, params, instanceId),
        dataFailed: (0, getFailedData_1.getFailedData)(apiData, endpointKey, params, instanceId),
        loading: (0, getLoadingState_1.getLoadingState)(apiData, endpointKey, params, instanceId),
        request: request || (0, getRequest_1.getRequest)(apiData, endpointKey, params, instanceId) || (0, createRequest_1.default)(endpointKey),
        perform: function (performParams, body) {
            params = __assign(__assign({}, bindingParams), performParams);
            return dispatch((0, performRequest_1.performRequest)(endpointKey, params, body, instanceId, bindingsStore, config));
        },
        invalidateCache: function () { return dispatch((0, invalidateRequest_1.invalidateRequest)(endpointKey, params, instanceId)); },
        purge: function () { return dispatch((0, purgeRequest_1.purgeRequest)(endpointKey, params, instanceId)); },
