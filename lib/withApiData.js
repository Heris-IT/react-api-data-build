...
var shouldPerformRequest = function (newProps, oldProps, bindings, bindingKey) {
    var keyParamsHaveChanged = function (key) { return !(0, shallowequal_1.default)(newProps.params[key], oldProps.params[key]); };
    var getApiDataRequest = function (props, key) {
        return (0, getRequest_1.getRequest)(props.apiData, bindings[key], props.params[key]);
    };
    ...
    return ((keyParamsHaveChanged(bindingKey) && (0, exports.shouldAutoTrigger)(newProps.apiData, bindings[bindingKey]) === true) ||
        (apiDataChanged &&
            hasBeenInvalidated(getApiDataRequest(oldProps, bindingKey), getApiDataRequest(newProps, bindingKey)) &&
            (0, exports.shouldAutoTrigger)(newProps.apiData, bindings[bindingKey]) === true) ||
        (apiDataChanged &&
            (0, exports.shouldAutoTrigger)(oldProps.apiData, bindings[bindingKey]) === false &&
            (0, exports.shouldAutoTrigger)(newProps.apiData, bindings[bindingKey]) === true));
};
exports.shouldPerformRequest = shouldPerformRequest;
var shouldAutoTrigger = function (apiData, endpointKey) {
    var _a, _b;
...
exports.shouldAutoTrigger = shouldAutoTrigger;
/**
        ...
        var WithApiData = /** @class */ (function (_super) {
                ...
                Object.keys(bindings).forEach(function (bindingKey) {
                    ...
                    if (Array.isArray(prevProps.params[bindingKey])) {
                        ...
                        paramsArray.forEach(function (params, index) {
                            var _a, _b;
                            if ((0, exports.shouldPerformRequest)(__assign(__assign({}, _this.props), { params: (_a = {},
                                ...
                                _this.props.dispatch((0, performRequest_1.performRequest)(bindings[bindingKey], params, undefined, index.toString(), undefined, bindingConfig));
                            }
                        });
                    }
                    else {
                        if ((0, exports.shouldPerformRequest)(_this.props, prevProps, bindings, bindingKey)) {
                            _this.props.dispatch((0, performRequest_1.performRequest)(bindings[bindingKey], _this.props.params[bindingKey], undefined, undefined, undefined, bindingConfig));
                        }
                    }
                });
            };
            ...
            WithApiData.prototype.fetchDataIfNeeded = function () {
                ...
                Object.keys(bindings).forEach(function (propName) {
                    ...
                    if ((0, exports.shouldAutoTrigger)(_this.props.apiData, endpointKey)) {
                        ...
                        if (Array.isArray(params[propName])) {
                            ...
                            paramsArray.forEach(function (propNameParams, index) {
                                dispatch((0, performRequest_1.performRequest)(endpointKey, propNameParams, undefined, index.toString(), _this.bindingPropNameBindingsStore[propName], bindingConfig));
                            });
                        }
                        else {
                            dispatch((0, performRequest_1.performRequest)(endpointKey, params[propName], undefined, '', _this.bindingPropNameBindingsStore[propName], bindingConfig));
                        }
                    }
                });
            };
            WithApiData.prototype.render = function () {
                var _this = this;
                var _a = this.props, apiData = _a.apiData, params = _a.params, dispatch = _a.dispatch, _b = _a.isSSR, isSSR = _b === void 0 ? (0, getIsSSR_1.getIsSSR)() : _b, componentProps = __rest(_a, ["apiData", "params", "dispatch", "isSSR"]);
                if (isSSR) {
                    this.fetchDataIfNeeded();
                }
                var addProps = {};
                ...
                var checkLoading = function (binding, instanceId) {
                    ...
                    if (binding.request.networkStatus === 'loading' && enableSuspense) {
                        var requestKey = (0, getRequestKey_1.getRequestKey)(binding.request.endpointKey, binding.request.params || {}, instanceId);
                ...
                var actions = (0, getActions_1.getActions)(dispatch);
                return react_1.default.createElement(WrappedComponent, __assign({}, componentProps, addProps, { actions: actions }));
            };
            WithApiData.displayName = "WithApiData(".concat(WrappedComponent.displayName || WrappedComponent.name || 'Component', ")");
            return WithApiData;
        }(react_1.default.Component));
        (0, hoist_non_react_statics_1.default)(WithApiData, WrappedComponent); // move static methods to wrapper
        return (0, react_redux_1.connect)(function (state, ownProps) { return ({
